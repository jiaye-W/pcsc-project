...
execute_process(
  COMMAND "/usr/bin/git" show-ref "boost-1.76.0"
  WORKING_DIRECTORY "/mnt/d/EPFL/GitHub/pcsc_project/cmake-build-debug/external/boost"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "boost-1.76.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("boost-1.76.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/boost-1.76.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/d/EPFL/GitHub/pcsc_project/cmake-build-debug/external/boost'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/d/EPFL/GitHub/pcsc_project/cmake-build-debug/external/boost'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
